...
export default function Tasas() {
  // --- Estados como string para inputs ---
      ...
      <div className="wrap">
        ...
        <section className="card">
          ...
          <div className="rows">
            ...
            <Row label={`Retención en la fuente ${retencionPct} %`} value={fmt(res.retencion)} info divider />
            <Row highlight label={<>Rentabilidad de tu CDT al <br /> vencimiento</>} value={fmt(res.totalVenc)} />
          </div>
          <div className="ctaBox">
            <button className="btnPrimary">Quiero mi CDT</button>
          </div>
        </section>
      </div>
    </div>
